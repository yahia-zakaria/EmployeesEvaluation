        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastEvauationDate = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "EmployeesStatisticDto",
                columns: table => new
                {
                    AllEmployees = table.Column<int>(type: "int", nullable: false),
                    EvaluatedEmployees = table.Column<int>(type: "int", nullable: false),
                    NotEvaluatedEmployees = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EvaluationReport", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Score_Criteria_CriterionId",
